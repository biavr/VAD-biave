...
from projects.mmdet3d_plugin.datasets.samplers.sampler import SAMPLER, build_sampler
...
def build_dataloader(dataset,
    ...
    if dist:
        ...
        if shuffle:
            # 🚀 DIRECT INSTANTIATION: Completely bypasses MMEngine's string registry mapping
            ...
            # Direct instantiation fallback for standard distributed tracking sampler sequential splits
            sampler = TorDistSampler(
                dataset=dataset,
                num_replicas=world_size,
                rank=rank,
                shuffle=shuffle,
